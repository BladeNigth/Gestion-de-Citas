                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="frist_name">Contraseña</label>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control" type="number" name="identificacion" placeholder="Cedula"
                                               >
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="frist_name" style="color: #574B90">Fecha de Nacimiento</label>
                                        <input class="form-control" type="date" name="Fecha" placeholder="Fecha de Nacimiento"
                                               >
                                    </div>
                                    <div class="form-group col-6">
                                        <label class="label" for="frist_name" style="color: #574B90" >Sexo</label>
                                    ...
                                    <button name = "registro"  type="submit" value="send" class="btn btn-primary btn-block">
                                        Crear
                                    </button>
                                    <!-- </div>-->
                                </form>
